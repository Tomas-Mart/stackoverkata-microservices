...
# Руководство по настройке и запуску проекта stackoverkata-profile-service
...
LOCAL_DB_PORT=5432
LOCAL_DB_NAME=local_profile_service
...
DB_DRIVER=com.mysql.cj.jdbc.Driver
# Действие Hibernate при запуске (validate/update/create)
DDL_AUTO=validate
